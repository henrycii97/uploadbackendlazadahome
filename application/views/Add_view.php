          ...
          <div class="content-view">
             <form action="<?= base_url() ?>home/add" method="post" enctype="multipart/form-data">
                 ...
                 <div class="form-group">
                   ...
                   <input type="text" name="productname" id="productname" class="form-control" placeholder="" aria-describedby="helpId">
                 ...
                 <div class="form-group">
                    ...
                    <input type="number" name="prices" id="prices" class="form-control" placeholder="" aria-describedby="helpId">
                    <small id="helpId" class="text-muted">Help text</small>
                  </div>
                 <div class="form-group">
                    <label for="">Mô tả </label>
                   <textarea name="description" class="description form-control" id="description" cols="30" rows="10"></textarea>
                    <small id="helpId" class="text-muted">Help text</small>
                  </div>
