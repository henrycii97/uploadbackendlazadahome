    ...
    <div class="app">
      ...
      <div class="sidebar-panel">
        <div class="brand">
          ...
          <!-- logo -->
          <a class="brand-logo">
             <img class="" style="width: 150px; height: 50px;" src="<?= base_url() ?>images/logolazada.png" alt="">
          </a>
          <!-- /logo -->
        </div>
          ...
          <div class="content-view">
             <form action="<?= base_url() ?>home/update" method="post" enctype="multipart/form-data">
               <div class="form-group">
                   <label for="">Danh mục ngành hàng</label>
                     
                   <select name="idcategory" id="idcategory" class="form-control">
                       
                     <?php foreach ($catefory as $key => $value): ?>
                             <option value="<?= $value['idcategory'] ?> "> <?php echo $value['tendanhmuc']; ?></option>
                      <?php endforeach ?> 
              ...
              <?php foreach ($edit as $key => $value): ?>
                 ...
                 <div class="form-group">
                   ...
                   <div id="helpId" class="text-muted">Đây là hình ảnh chính trên trang sản phẩm. Bạn có thể up nhiều hình ảnh cùng lúc và tối đa có thể có 8 hình. Hình ảnh cần có kích thước từ 330x300 px đến 5000x5000px và không dược phép chứa nội dung nhạy cảm.</div>
                   <img src="<?= $value['image'] ?>" alt="">
                   <input type="hidden" value="<?= $value['id'] ?>" name="id" class="form-control">
                   <input type="hidden" value="<?= $value['image'] ?>" name="image_old" class="form-control">
                   <input type="file" name="image" id="image" value="<?= $value['image'] ?>" class="form-control" placeholder="" aria-describedby="helpId">
                 </div>
                 <div class="form-group">
                   <label for="">Tên sản phẩm</label>
                   <input type="text" name="productname" id="productname" value="<?= $value['productname'] ?>"  class="form-control" placeholder="" aria-describedby="helpId">
                   <small id="helpId" class="text-muted">Help text</small>
                 </div>
                
                 </div>
                 <div class="form-group">
                    <label for="">Video cho sản phẩm</label>
                    <video width="320" height="240" controls>
                    <source src="<?= $value['video'] ?>" type="video/mp4">
                    
                       Your browser does not support the video tag.
                    </video>
                    <input type="hidden" name="video_old" id="video" value="<?= $value['video'] ?>" class="form-control" placeholder="" aria-describedby="helpId">
                    <input type="file" name="video" id="video"  class="form-control" placeholder="" aria-describedby="helpId">
                    <small id="helpId" class="text-muted">Help text</small>
                  </div>
                   <div class="form-group">
                    <label for="">Giá </label>
                    <input type="number" name="price" value="<?= $value['price'] ?>" id="price" class="form-control" placeholder="" aria-describedby="helpId">
                    <small id="helpId" class="text-muted">Help text</small>
                  </div>
                 <div class="form-group">
                    <label for="">Giá đặc biệt </label>
                    <input type="number" name="prices" value="<?= $value['prices'] ?>" id="prices" class="form-control" placeholder="" aria-describedby="helpId">
                    <small id="helpId" class="text-muted">Help text</small>
                  </div>
                  <div class="form-group">
                    <label for="">Mô tả </label>
                   <textarea name="description" class="description form-control"  id="description" cols="30" rows="10"><?php echo $value['description'] ?></textarea>
                    <small id="helpId" class="text-muted">Help text</small>
                  </div>
                 <div class="form-group">
                    <label for="">Hình ảnh chi tiết</label>
                    <?php $img = json_decode($value['images'],true);?>
                       <textarea name="images_old"  style="display: none;" id="" cols="30" rows="10"> <?php echo $value['images'] ?> </textarea>
                     <input type="file" name="images[]"  id="images" multiple="multiple" class="form-control" placeholder="" aria-describedby="helpId">
                    <?php $images = json_decode($value['images'],true); ?>
                     <div class="card-columns">
                     <?php foreach ($img as  $value): ?>
                         
                      <div class="card col-3">
                    <img class="card-img-top img-fluid" src="<?= $value['img'] ?>" alt="">
                      </div>
